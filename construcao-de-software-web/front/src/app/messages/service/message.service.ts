...
export class MessageService {
  ...
  getMessage() {
    return this.http.get(environment.apiBaseUrlMessage + '/listarMensagens', {});
  }
  addMessage(content: string, user: User): Observable<any> {
    return this.http.post(environment.apiBaseUrlMessage + '/enviarMensagem', {
      Content: content,
      Usuario: user,
    });
  }
